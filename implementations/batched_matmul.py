...
def matmul_kernel(
        ...
        batch_stride_a,stride_am, stride_ak,
        batch_stride_b,stride_bk, stride_bn,
        batch_stride_c,stride_cm, stride_cn,
        # Meta-parameters
...
def batched_matmul(a, b):
    ...
    grid = lambda META: (
        triton.cdiv(M, META['BLOCK_SIZE_M']) * triton.cdiv(N, META['BLOCK_SIZE_N']),batch_size,
    )
    matmul_kernel[grid](
        a, b, c,
        M, N, K,
